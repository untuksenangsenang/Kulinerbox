    ...
    <footer className="bg-brand-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/70 text-sm leading-relaxed max-w-sm mb-6">
              Menyediakan paket nasi box dan snack box berkualitas untuk rapat
              kantor, hajatan, seminar, arisan, dan berbagai acara lainnya.
            ...
            <div className="flex gap-3">
              {siteConfig.social.instagram && (
                <a
                  ...
                  aria-label="Instagram Kulinerbox"
              ...
              {siteConfig.social.tiktok && (
                ...
                >
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V9.61a8.16 8.16 0 004.77 1.52V7.68a4.85 4.85 0 01-1-.99z" />
                  </svg>
                </a>
              )}
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp Kulinerbox"
                className="w-9 h-9 rounded-full bg-wa/20 flex items-center justify-center hover:bg-wa transition-colors"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white/70 hover:text-brand-primary transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex gap-2 text-wa hover:text-green-400 transition-colors"
                >
                  <svg
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/50">
          <p>
            © {year} Kulinerbox. Hak cipta dilindungi undang-undang.
          </p>
          <p className="text-xs">
            Website dibuat dengan ❤️ untuk UMKM Indonesia
          </p>
        </div>
      </div>
    </footer>
